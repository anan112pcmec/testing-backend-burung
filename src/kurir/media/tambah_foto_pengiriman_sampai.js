// k6 run media/tambah_foto_pengiriman_sampai.js

import http from 'k6/http';
import { check, sleep } from 'k6';

// 1️⃣ Baca file sekali di awal (foto sampai)
const fileBytes = open('foto/sampai.jpg', 'b');
...
export default function () {
  ...
  const presignedRes = http.put(
    "http://localhost:8080/kurir/media/tambah-foto-pengiriman-non-ekspedisi-sampai",
    payload,
    {
  ...
  check(uploadRes, {
    "upload sampai success": (r) => r.status === 200 || r.status === 204,
  });
