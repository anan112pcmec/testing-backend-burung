// k6 run media/tambah_foto_informasi_kendaraan_bpkb.js

import http from 'k6/http';
import { check, sleep } from 'k6';

// 1️⃣ Baca file sekali di awal (BPKB)
const fileBytes = open('foto/bpkb.jpg', 'b');
...
export default function () {
  ...
  const presignedRes = http.put(
    "http://localhost:8080/kurir/media/tambah-foto-informasi-kendaraan-kurir-bpkb",
    payload,
    {
  ...
  check(uploadRes, {
    "upload BPKB success": (r) => r.status === 200 || r.status === 204,
  });
