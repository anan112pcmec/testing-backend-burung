// k6 run media/tambah_foto_brand_data_nib.js

import http from 'k6/http';
import { check, sleep } from 'k6';

// 🔥 BACA FILE SEKALI (contoh JPG)
const fileBytes = open('foto/brand_nib.jpg', 'b');
...
export default function () {
  ...
  const presignedRes = http.put(
    "http://localhost:8080/seller/media/tambah-foto-brand-data-nib",
    payload,
    {
      headers: {
  ...
  check(uploadRes, {
    "upload foto brand NIB success": (r) =>
