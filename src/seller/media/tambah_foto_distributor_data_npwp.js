// k6 run media/tambah_foto_distributor_data_npwp.js

import http from 'k6/http';
import { check, sleep } from 'k6';

// 1️⃣ BACA FILE SEKALI DI AWAL (FOTO NPWP)
const fileBytes = open('foto/npwp.jpg', 'b');
...
export default function () {
  ...
  const presignedRes = http.put(
    "http://localhost:8080/seller/media/tambah-foto-distributor-data-npwp",
    payload,
    {
      headers: {
