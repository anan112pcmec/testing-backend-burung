...
export default function () {
    const url = 'http://localhost:8080/seller/profiling/personal-update';

    const payload = JSON.stringify({
       id_seller: 1,
       update_username_seller: "adidas",
       update_nama_seller: "Mantap",
       update_email_seller: "ananlol156@gmail.com"
    });
